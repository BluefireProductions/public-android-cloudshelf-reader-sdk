...
TARGET="${pwd}/android-cloudshelf-reader-sdk/assets/readium-shared-js"
...
JS_FILE="${pwd}/android-cloudshelf-reader-sdk/assets/readium-shared-js/epubReadingSystem_.js"
